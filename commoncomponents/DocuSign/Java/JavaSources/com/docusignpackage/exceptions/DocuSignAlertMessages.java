package com.docusignpackage.exceptions;
...
public class DocuSignAlertMessages {
	...
	public static final Message ERROR_PROCESSING_RESPONSE_FOR_ESIGN = DOCU_SIGN_MESSAGE_SET.getMessage("processingResponseForESignature");
