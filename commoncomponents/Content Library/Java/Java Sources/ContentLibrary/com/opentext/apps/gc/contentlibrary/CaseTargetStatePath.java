...
public class CaseTargetStatePath extends CaseTargetStatePathBase
{
    ...
    public static BusObjectIterator<com.opentext.apps.gc.contentlibrary.CaseTargetStatePath> getCaseTargetStatePathObjects(com.cordys.cpc.bsf.query.Cursor cursor)
    {
        // TODO implement body
        return null;
    }
    ...
    public static int getTargetStatePath(String currentState, String targetState, String modelFQN)
	{
		...
		try
		{
			...
			if(transitionPath==0) {
				caseSCXML =(modelFQN.substring(modelFQN.lastIndexOf("/") + 1)=="GCClause")?Utilities.parseXML(ClauseConstants.CLAUSE_CASE_MODEL_XML.toString()):Utilities.parseXML(TemplateConstants.TEMPLATE_CASE_MODEL_XML.toString());
				transitionPath = prepareCaseTransitions(caseSCXML,currentState,targetState);
			}
		}
		finally
